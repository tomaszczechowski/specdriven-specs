...
Briefly describe your spec and why it's useful:

(Replace this with your description)

---

**Automated validation:** GitHub Actions will validate your submission. Watch for any errors in the checks below.

Need help? See [CONTRIBUTING.md](./CONTRIBUTING.md) and [SPEC_REQUIREMENTS.md](./SPEC_REQUIREMENTS.md).
